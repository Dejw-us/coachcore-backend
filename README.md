...
- [Profile service](https://github.com/CoachCore/Backend-microservices/tree/dev/profile-service#readme) is used for managing user avatars
...
#### See [Docker instructions](https://github.com/CoachCore/Backend-microservices/tree/dev/scripts/python#python-scripts) to build docker images locally
