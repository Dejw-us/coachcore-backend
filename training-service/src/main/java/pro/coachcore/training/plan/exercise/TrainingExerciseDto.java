...
public record TrainingExerciseDto(String id, CatalogExerciseDto catalogExercise, String notes,
    IntensityType intensityType, WeightType weightType, Long index) {
}
